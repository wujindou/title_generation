...
with open('D:/train_qg.txt','r',encoding='utf-8') as lines:
...
with open('D:/dev_qg.txt','r',encoding='utf-8') as lines:
    for idx,line in enumerate(lines):
        if idx>1000:continue
        dev_dataset.append(line.strip().split('\t'))
# 基本参数
maxlen = 256
batch_size = 16
epochs = 10000
